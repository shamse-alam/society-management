  ...
  return (
    <div>
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
        <div>
          <h1 className="text-xl font-semibold text-heading">Amenity Booking</h1>
          <p className="text-[13px] text-muted mt-0.5">Book function hall & guest bedrooms</p>
        </div>
        <button onClick={() => { setForm({ userId: '', amenityId: '', bookingDate: today, bookingEndDate: today, purpose: '' }); setError(''); setModalOpen(true); }}
          className="btn-primary inline-flex items-center gap-2 bg-indigo-600 text-white px-4 py-2 rounded text-[13px] font-medium hover:bg-indigo-700 transition-colors">
        ...
        <form onSubmit={handleBook}>
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="flex items-center gap-2">
              ...
              <button type="submit" disabled={saving || !form.amenityId || !form.bookingDate || !form.bookingEndDate || (isAdmin && !form.userId)} className="px-4 py-2 bg-indigo-600 text-white rounded text-[13px] font-medium hover:bg-indigo-700 disabled:opacity-50 transition-colors inline-flex items-center gap-2">
